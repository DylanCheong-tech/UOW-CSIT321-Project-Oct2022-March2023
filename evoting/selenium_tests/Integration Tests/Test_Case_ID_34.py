...
# login to the system
driver.get("http://127.0.0.1:8000/harpocryption/voter/vote?auth=ecBwSbLr1a2QSMqfTfbQ8PZEP0lVXf0bPOyI5RG3FD8gtXma3DLVbsUWRcZ91lwW")

error_message = driver.find_element(By.ID, "error_message").text

assert driver.title == "Error"
assert error_message == "Vote Event has been ended !"

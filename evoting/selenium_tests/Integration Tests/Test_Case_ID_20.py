...
"""
Title: Event Owner Delete Vote Event successfully 

Descriptions:
Test the system to be able delete the vote event records correctly from the system database
"""
import os 
...
event_list =  []
for row in driver.find_elements(By.CSS_SELECTOR, "table tr:not(.header) td:nth-child(2)"):
	event_list.append(row.get_attribute("innerHTML"))

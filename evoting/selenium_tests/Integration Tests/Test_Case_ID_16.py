...
"""
Title: Event Owner Updates Vote Event in Pending Confirmation (PC) with invalid end datetime settings 

Descriptions:
Test the system to be able to identify the invalid end datetime when a user is trying to update a vote event by providing an ending datetime before the starting datetime. 
...
print("Integration Test 16 Passed !")

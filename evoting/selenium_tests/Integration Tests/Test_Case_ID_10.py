...
"""
Title: Event Owner Creates Vote Event with invalid start datetime settings 

Descriptions:
Test the system to be able to identify the invalid start datetime when a user is trying to create a vote event by providing a starting datetime before the timestamp of creation. 
...
# fill in the form data
driver.find_element(By.NAME, "eventTitle").send_keys("Vote Event Name 2")
...
driver.find_element(By.NAME, "eventQuestion").send_keys("Vote Question 2")

driver.find_element(By.CSS_SELECTOR, 'span.options_and_file span.fields:nth-child(2) input').send_keys("Option 2A")
driver.find_element(By.CSS_SELECTOR, 'span.options_and_file span.fields:nth-child(3) input').send_keys("Option 2B")
...
print("Integration Test 10 Passed !")

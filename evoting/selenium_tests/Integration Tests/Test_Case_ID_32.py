...
# login to the system
driver.get("http://127.0.0.1:8000/harpocryption/voter/vote?auth=HsCEGsZ9mT6tDJvgGxYloya59ycwwOQcIm2hPlfJPtxZvXiMOklopsXbH52Y3beB")

error_message = driver.find_element(By.ID, "error_message").text

assert driver.title == "Error"
assert error_message == "Voter Information Not Found !"
